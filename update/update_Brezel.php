...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE vorbestellung SET Brezel = Brezel + $increment";


    if ($conn->query($sql) === TRUE) {
        $_SESSION['message'] = "Sie haben erfolgreich $increment Brezel(n) vorbestellt";
    } else {
    ...
    echo "Es gab einen Fehler bei ihrer Vorbestellung, bitte kontaktieren Sie den Kiosk!";
}
